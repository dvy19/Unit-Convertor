...
class lengthActivity : AppCompatActivity() {
    ...
    private val lengthUnits = arrayOf("cm", "m", "km")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        inputNumber = findViewById(R.id.length_input)
        outputNumber = findViewById(R.id.len_output) // Assuming this is your second input field
    ...
    private fun setupListeners() {
        // Listener for first input field (length_input)
