...
class volumeActivity : AppCompatActivity() {
    ...
    private val volumeUnits = arrayOf("cm", "m")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        inputNumber = findViewById(R.id.volume_input)
        outputNumber = findViewById(R.id.volume_output) // Assuming this is your second input field
        fromSpinner = findViewById(R.id.volume_from)
        toSpinner = findViewById(R.id.volume_to)
    ...
    private fun setupListeners() {
        // Listener for first input field (volume_input)
